<header class="header_section2" style="margin-bottom: 0px; padding-bottom: 0px; background-color: #212121;">
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav" style="margin-left: auto">
                    ...
                    @if (Route::has('login'))
                        @auth
                        @if(Request::path() != 'order/billing' && Request::path() != 'completeorder')
                        <li class="nav-item">
